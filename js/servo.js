...
fetchGithubApi('https://api.github.com/repos/mvdam/arduino-github/issues')
.then(console.log)
...
const updateBugOMeter = async (led, servo) => {
  ...
  const issues = await fetchGithubApi('https://api.github.com/repos/mvdam/arduino-github/issues')
